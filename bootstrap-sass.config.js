module.exports = {
    ...
    preBootstrapCustomizations: './source/styles/_pre-bootstrap-customizations.scss',
    ...
    bootstrapCustomizations: './source/styles/_bootstrap-customizations.scss',

    mainSass: './source/styles/app.scss',
    verbose: true,
    debug: false,
